...
custom_collate = torch.utils.data.dataloader.default_collate
...
#                 storage = elem.untyped_storage()._new_shared(numel).cuda()
#                 out = elem.new(storage)
#             else:
#                 storage = elem.untyped_storage()._new_shared(numel)
#                 out = elem.new(storage)
#             print(len(batch), print(batch[0].shape), print(out.shape))
